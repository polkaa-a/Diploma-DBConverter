...
public abstract class MongoDBDTOToPostgreSQLDTOConverter
    ...
    private Stream<PostgreSQLFieldDTO> getFilteredFields(PostgreSQLTableDTO tableDTO, String name) {
    ...
    private Stream<PostgreSQLFieldDTO> getSimilarFields(PostgreSQLTableDTO tableDTO, String name, PostgreSQLTypes type) {
        var filteredFields = getFilteredFields(tableDTO, name);
        return filteredFields.filter(f -> !f.getType().equals(type));
    }

    private Stream<PostgreSQLFieldDTO> getIdenticalFields(PostgreSQLTableDTO tableDTO, String name, PostgreSQLTypes type) {
        var filteredFields = getFilteredFields(tableDTO, name);
